...
int main(void)
{
  /* USER CODE BEGIN 1 */
	...
	GPIOD->MODER =0X55540000; //12,13,14,15 PIN
	GPIOD->OTYPER=0X00;
	GPIOD->OSPEEDR=0XFFFC0000;
	GPIOA->PUPDR=0X00;
...
switch (sayim){
	case 0:
	GPIOD->ODR =0X00007e00;//0
	break;
	case 1:
	GPIOD->ODR =0X00000600;//1
	break;
	case 2:
	GPIOD->ODR =0X0000da00;//2
	break;
	case 3:
	GPIOD->ODR =0X0000ce00;//3
	break;
	case 4:
	GPIOD->ODR =0X0000a600;//4
	break;
	case 5:
	GPIOD->ODR =0X0000ec00;//5
	break;
	case 6:
	GPIOD->ODR =0X0000fc00;//6
	break;
	case 7:
	GPIOD->ODR =0X00000E00;//7
	break;
	case 8:
	GPIOD->ODR =0X0000FE00;//8
	break;
	case 9:
	GPIOD->ODR =0X0000ee00;//9
	break;
